...
class Datasets(Dataset):
    ...
    def __init__(self, path1, path2, train=False):
        self.path1 = path1
        self.path2 = path2
        self.datasets = []
        if train:
            self.datasets.extend(open(os.path.join(path1, r'train_label.txt')).readlines())
        else:
...
if __name__ == '__main__':
    data = Datasets(r'D:\E\document\datas\megaage_asian\list', r'D:\E\document\datas\megaage_asian\train')
